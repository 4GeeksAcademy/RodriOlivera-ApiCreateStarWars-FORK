...
Revision ID: e99a43caa41b
Revises: b41a823ef216
Create Date: 2023-08-30 17:00:17.591953
...
revision = 'e99a43caa41b'
down_revision = 'b41a823ef216'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['favourite_id'], ['favorite.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
